...
<th class="<?php echo $_class ?>">
    <a href="<?php echo $this->url(sprintf('/card/%s/%d/%d/%s/%d/%d/', $action, 1, $limit, $layout, $_i, $_dir)) ?>"><?php echo __($record->getMeta('type').'_label_'.$_attribute['attribute']) ?></a>
</th>
<?php endforeach ?>
