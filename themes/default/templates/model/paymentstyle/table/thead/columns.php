<?php
/**
 * Paymentstyle table row partial.
 *
 * @package Cinnebar
 * @subpackage Template
 * @author $Author$
...
<th class="<?php echo $_class ?>">
    <a href="<?php echo $this->url(sprintf('/paymentstyle/index/%d/%d/%s/%d/%d/', 1, $limit, $layout, $_i, $_dir)) ?>"><?php echo __($record->getMeta('type').'_label_'.$_attribute['attribute']) ?></a>
</th>
<?php endforeach ?>
