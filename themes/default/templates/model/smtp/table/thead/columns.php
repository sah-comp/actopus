...
<th class="<?php echo $_class ?>">
    <a href="<?php echo $this->url(sprintf('/smtp/index/%d/%d/%s/%d/%d/', 1, $limit, $layout, $_i, $_dir)) ?>"><?php echo __($record->getMeta('type').'_label_'.$_attribute['attribute']) ?></a>
</th>
<?php endforeach ?>
