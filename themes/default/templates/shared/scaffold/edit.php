...
<div id="main" class="main">
    <section>
        <header>
            <h1 class="visuallyhidden"><?php echo __('scaffold_h1_edit') ?></h1>
            <?php if (isset($pageflip) && is_a($pageflip, 'Cinnebar_Menu')): ?>
                <nav class="pageflip">
                    <h2 class="visuallyhidden"><?php echo __('menu_pageflip') ?></h2>
                    <?php echo $pageflip->render(array('class' => 'pagination pageflip-menu clearfix')) ?>
                </nav>
            <?php endif ?>
        </header>
