...
<body
    ...
    <table
        style="width: 700px; padding: 0 10px 0 10px; background-color: #ffffff;" align="center">
        <tr>
            <td
                colspan="2"
                style="text-align: center;">
                <a
                    href="<?php echo $this->url(sprintf('/newsletter/view/%d/', $record->getId())) ?>"
                    style="color: #aaafaf; font-size: 10px;">
                    <?php echo __('newsletter_linktext_view_in_browser') ?>
                </a><br /><br />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td
                ...
                <br /><br /><br /><br />
                <a
                    href="<?php echo $this->url(sprintf('/newsletter/optout/%s', $queue->emailhash)) ?>"
                    style="color: #aaafaf; font-size: 12px;">
                    <?php echo __('newsletter_linktext_optout') ?>
                </a>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <img src="<?php echo $this->url(sprintf('/newsletter/queue/%s/?%d', $queue->hash, md5(time()+rand(1, getrandmax())))) ?>" style="width: 1px; height: 1px; border: 0;" alt="" />
            </td>
        </tr>
        <tr>
            <td
