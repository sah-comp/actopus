...
/**
 * Manages smtp server beans.
 *
 * @package Cinnebar
 * @subpackage Model
 * @version $Id$
 */
class Model_Smtp extends Cinnebar_Model
{
    /**
...
SQL;
    ...
    public function dispense()
    {
        ...
        $this->addValidator('host', 'hasvalue');
        $this->addValidator('user', 'hasvalue');
        $this->addValidator('port', 'hasvalue');
        $this->addValidator('port', 'isnumeric');
        if ( ! $this->bean->getId()) $this->bean->port = 25;
    }
}
